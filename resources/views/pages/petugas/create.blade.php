...
@section('title', 'Tambah | Daftar Petugas Pamsimas - MTI Priangan')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Tambah Daftar Petugas</h4>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Tambah Daftar Petugas SIPA Pamsimas </h4>
                    <p class="card-title-desc">Tambah daftar petugas </code>.
                    </p>
